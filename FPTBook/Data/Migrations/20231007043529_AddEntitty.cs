...
{
    /// <inheritdoc />
    public partial class AddEntitty : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewGenres", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NewGenres_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Authorities_AuthorId",
                        column: x => x.AuthorId,
